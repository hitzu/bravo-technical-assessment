enum ErrorMessages {
  ...
  INVALID_DOCUMENT_FORMAT_FOR_COUNTRY = 'INVALID_DOCUMENT_FORMAT_FOR_COUNTRY',
...
> = {
  ...
  [ErrorMessages.INVALID_DOCUMENT_FORMAT_FOR_COUNTRY]: {
    code: 12,
    message: 'formato de documento inválido para el país',
  },
};
