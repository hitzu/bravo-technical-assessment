...
export class Migration1769286366652 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE "public"."CREDIT_APPLICATION_STATUS" AS ENUM ('PENDING','IN REVIEW','APPROVED','REJECTED','ERROR')`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP TYPE "public"-"CREDIT_APPLICATION_STATUS"`);
